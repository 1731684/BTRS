...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container-fluid">
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item" style="">
                            <img src="<?php echo e(url('/frontend/assets/uploads/images/6.jpg')); ?>" alt="" class="">
                        </div>
                        <div class="item active">
                            <img src="<?php echo e(url('/frontend/images/bus.jpg')); ?>" alt="" class="">
                        </div>
                        <div class="item" style="">
                            <img src="<?php echo e(url('/frontend/assets/uploads/images/7.jpg')); ?>" alt="" class="">
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10  col-md-offset-1" style="padding-right: 28px">
                                            ...
                                            <input type="text" id="datepicker" name="departure_date"
                                                   class="search-form-control form-material" placeholder="Enter Departure Date"  autocomplete="off" required>
            ...
            <!--  <div class="col-md-6 col-sm-12 col-xs-12" style="float: right;">
               ...
               <div class = "section-title" data-animation = "fadeInUp">
                ...
                <input id="email" type="email" class="form-control" name="email" id="userRegisterEmail" value="<?php echo e($email); ?>" required placeholder="Email*">
    ...
    <section id="twitter" class="page-section light-bg">
        <div class="image-bg content-in fixed"
             data-background="url(<?php echo e(url('/frontend/images/sections/bg/bg-10.jpg')); ?>)"
             style="background-image: url(<?php echo e(url('/frontend/images/sections/bg/bg-10.jpg')); ?>)">
