                ...
                <div class="col-12 col-lg-12">
                    <div class="box">
                        <div class="box-header">
                            <h4><b>Who we are</b>&nbsp;&nbsp;&nbsp;<a href="<?php echo e(route('createWhoweare')); ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <th>
                                                                <form action="<?php echo e(route('showWhoweare')."/".$key->whoweare_id); ?>"
                                                                      method="get">
                                                            ...
                                                            <th>&nbsp;</th>
                                                            <th>
                                                                <form action="<?php echo e(route('editWhoweare')."/".$key->whoweare_id); ?>"
                                                                      method="get">
                                                                    <button type="submit"
                                                            ...
                                                            <th>&nbsp;</th>
                                                            <th>
                                                                <form action="<?php echo e(route('destroyWhoweare')); ?>"
                                                                      method="post" onsubmit=" return ConfirmDelete()">
                                                                    <?php echo e(csrf_field()); ?>

                                                                    <input type="hidden" name="id"
                                                                           value="<?php echo e($key->whoweare_id); ?>">
