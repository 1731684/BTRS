                ...
                <div class="col-12 col-lg-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="<?php echo e(route('createWhyus')); ?>" class="btn btn-default label-success">+ Add New</a>



                            <a href="<?php echo e(route('viewWhyus')); ?>" class="btn btn-info label-success pull-right" > <i class="glyphicon glyphicon-eye-open"></i> views all</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        <th>
                                                        <form action="<?php echo e(route('showSchedule')."/".$key->whyus_id); ?>"
                                                        method="get">
                                                        ...
                                                        <th>
                                                            <form action="<?php echo e(route('editWhyus')."/".$key->whyus_id); ?>" method="get">
                                                        ...
                                                        <th>
                                                            <form class="client" action="<?php echo e(route('destroyWhyus')); ?>" method="post" onsubmit=" return ConfirmDelete()">
                                                                <?php echo e(csrf_field()); ?>

                                                                <input type="hidden" name="id" value="<?php echo e($key->whyus_id); ?>">
